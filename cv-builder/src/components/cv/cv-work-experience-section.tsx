...
export function CVWorkExperienceSection({
  ...
  const labels = {
    ...
    modeWithDescriptionDesc:
      language === 'de' ? 'Grundinformationen + Beschreibung' : 'Basic info + description',
  ...
  const handleSelectionChange = (id: string, isSelected: boolean) => {
    onChange(
      workExperiences.map((exp) =>
        exp.id === id ? { ...exp, selection: { ...exp.selection, is_selected: isSelected } } : exp
      )
    );
  };
  ...
  const handleDisplayModeChange = (id: string, mode: WorkExperienceDisplayMode) => {
    onChange(
      workExperiences.map((exp) =>
        exp.id === id ? { ...exp, selection: { ...exp.selection, display_mode: mode } } : exp
      )
    );
  };
              ...
              >
                <div className="flex items-start gap-3 p-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <h4 className="truncate font-medium">{exp.title}</h4>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-0.5 rounded-md border">
                      ...
                      <Button
                        variant={
                          exp.selection.display_mode === 'with_description' ? 'secondary' : 'ghost'
                        }
                        size="sm"
                    ...
                    <div className="ml-7 space-y-4 border-t pt-3">
                      ...
                      <div className="space-y-3">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(value) =>
                            handleDisplayModeChange(exp.id, value as WorkExperienceDisplayMode)
                          }
                          className="space-y-2"
                        >
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="flex-1">
                              <Label
                                htmlFor={`${exp.id}-simple`}
                                className="cursor-pointer font-medium"
                              >
                                {labels.modeSimple}
                              </Label>
                              <p className="text-xs text-muted-foreground">
                                {labels.modeSimpleDesc}
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="flex-1">
                              <Label
                                htmlFor={`${exp.id}-with-desc`}
                                className="cursor-pointer font-medium"
                              >
                                {labels.modeWithDescription}
                              </Label>
                              <p className="text-xs text-muted-foreground">
                                {labels.modeWithDescriptionDesc}
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="flex-1">
                              <Label
                                htmlFor={`${exp.id}-custom`}
                                className="cursor-pointer font-medium"
                              >
                                {labels.modeCustom}
                              </Label>
                              <p className="text-xs text-muted-foreground">
                                {labels.modeCustomDesc}
                              </p>
                            </div>
                          </div>
                        </RadioGroup>
                        ...
                        <>
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea
                              ...
                              rows={3}
                              className={
                                exp.selection.description_override !== null ? 'border-primary' : ''
                              }
                            />
                            {exp.selection.description_override !== null && (
                              <p className="text-xs text-muted-foreground">
