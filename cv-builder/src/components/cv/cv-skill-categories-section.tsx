...
import { ChevronDown, ChevronRight,Star, Wrench } from 'lucide-react';
  ...
  const handleSelectionChange = (id: string, isSelected: boolean) => {
    onChange(
      skillCategories.map((cat) =>
        cat.id === id ? { ...cat, selection: { ...cat.selection, is_selected: isSelected } } : cat
      )
    );
  };
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Switch id="show-skills" checked={showSkills} onCheckedChange={onShowSkillsChange} />
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-3 p-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <h4 className="truncate font-medium">{cat.category}</h4>
