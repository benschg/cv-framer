...
export const CVPreviewSection = forwardRef<CVPreviewSectionHandle, CVPreviewSectionProps>(
  function CVPreviewSection(
    ...
    const handleSidebarSectionMove = (pageIndex: number, fromIndex: number, toIndex: number) => {
      ...
      const defaultSidebar: CVSidebarSection[] = [
        'photo',
        'contact',
        'skills',
        'languages',
        ...
        <CardHeader>
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <CardDescription>This is how your CV will look when exported</CardDescription>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 rounded-md border">
                ...
                <button
                  ...
                  className="min-w-[3.5rem] rounded px-2 text-center text-sm font-medium transition-colors hover:bg-accent"
                  title="Click to reset to auto"
                >
                  {zoomMode === 'auto' ? (
                    <span className="text-muted-foreground">{calculatedZoom}%</span>
                  ) : (
                    `${effectiveZoom}%`
                  )}
                </button>
